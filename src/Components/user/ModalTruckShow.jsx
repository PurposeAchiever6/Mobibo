        ...
        <div className="flex lg:flex-row flex-col w-[100%] gap-[40px] pb-[0px] md:pb-[100px]  justify-between">
          ...
          {viewModalType === "2d" ? (
            truckModalSide === "side" ? (
              <div className="lg:w-[83%] w-[100%]  truckShow-bg-side p-4 lg:px-[55px] px-[25px] lg:h-[412px] h-[198px] ">
                {selectedImageModalSide && ( // Display image preview if an image is selected
                  fileTypeModalSide.startsWith("image") ? (
                    <img
            ...
            <div className="lg:w-[80%] w-[100%]">
              <ThreeScene selectedImageSide={selectedImageModalSide} selectedImageBack={selectedImageModalBack} truckSide={truckModalSide} fileTypeSide={fileTypeModalSide} fileTypeBack={fileTypeModalBack} />
            </div>
          )}
        </div>
      </div>
